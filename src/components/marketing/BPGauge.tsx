  ...
  return (
    <div className="rounded-2xl border border-[#27324A] bg-[#141B2B] p-5">
      <div className="flex justify-between items-center mb-4">
        ...
        <span className="font-mono text-[9px] text-[#717C90] bg-[#27324A]/40 px-2 py-0.5 rounded-full">SCG CALIBRATED</span>
      </div>
      <div className="flex items-baseline gap-2 mb-4">
        <span className="font-display text-5xl font-bold text-[#EAF0FA]">{systolic}</span>
        <span className="font-display text-3xl text-[#717C90]">/</span>
      ...
      <div className="flex justify-between text-[10px] font-mono text-[#717C90]">
        <span>OPTIMAL</span>
        <span>NORMAL</span>
        <span>ELEVATED</span>
